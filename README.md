...
Kendala yang dihadapi lebih banyak berasal dari pemahaman konsep struktur data dan koordinasi tim. Beberapa materi cukup sulit dipahami di awal sehingga membutuhkan waktu tambahan. Selain itu, penggunaan Live Share dan GitHub juga menimbulkan kendala dalam sinkronisasi perubahan dan pengelolaan commit.

Untuk mengatasi hal tersebut, dilakukan:

1) Belajar mandiri dan mencari referensi tambahan

2) Pengecekan kode oleh setiap anggota kelompok

3) Diskusi dengan kelompok lain

4) Evaluasi rutin

5) Asistensi dengan asisten praktikum

✅ KESIMPULAN DAN REKOMENDASI

Aplikasi Listify.DS berhasil dikembangkan dengan memanfaatkan berbagai struktur data dinamis secara terintegrasi dan berjalan sesuai dengan rancangan awal.

Beberapa pengembangan yang direkomendasikan:

1. Menambahkan penyimpanan data permanen

2. Menambahkan fitur pencarian yang lebih cepat

3. Menambahkan fitur sorting pada library

4. Menambahkan tampilan yang lebih interaktif

5. Meningkatkan fitur pemutaran lagu

📚 Referensi

1. Slide Perkuliahan Struktur Data

2. Modul dan Tugas Praktikum Struktur Data

3. Repository GitHub pendukung perkuliahan
